...
public class RankWin extends JFrame {
	...
	public RankWin() {
		...
		gl_AllStudentpanel.setHorizontalGroup(
			gl_AllStudentpanel.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_AllStudentpanel.createSequentialGroup()
		...
		gl_AllStudentpanel.setVerticalGroup(
			gl_AllStudentpanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_AllStudentpanel.createSequentialGroup()
					.addGap(31)
					.addComponent(lblNewLabel_2)
					.addGap(36)
					.addComponent(lblNewLabel_3_2)
		...
		gl_Schoolpanel.setHorizontalGroup(
			gl_Schoolpanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Schoolpanel.createSequentialGroup()
					.addGap(96)
					.addGroup(gl_Schoolpanel.createParallelGroup(Alignment.LEADING)
		...
		gl_Schoolpanel.setVerticalGroup(
			gl_Schoolpanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Schoolpanel.createSequentialGroup()
					.addGap(24)
					.addComponent(lblNewLabel)
